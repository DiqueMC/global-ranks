...
public class Logger {
	private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GlobalRanks.getInstance().getName());
	...
	public static final String getLogPrefix() {
		return String.format(GlobalRanks.chatPrefix);
	}
